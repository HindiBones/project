...
public class ChatNachricht extends Nachricht{
	...
	/**
	 * Nachrichten-Objekt, das eine Nachricht in Textform enth�lt, die im Chat gesendet wurde
	 * @author Julius
	...
	public boolean istCheat(){
		...
		case ("<#unbesiegbar>"): istCheat = true;break;
		case ("<#durchsicht>"): istCheat = true;break;
